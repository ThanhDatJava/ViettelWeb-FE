...
const WifiUpdate = (props: IProps) => {
  ...
  useEffect(() => {
    if (dataUpdate) {
      ...
      form.setFieldsValue({
        ...
        numberdevices: dataUpdate.numberdevices,
      });
    }
  }, [dataUpdate]);
  ...
  const handleUpdateWifiAction = async (data: any) => {
    const res = await sendRequest<IBackendRes<any>>({
      url: `${process.env.NEXT_PUBLIC_BACKEND_URL}/api/v1/wifi/edit`,
      method: "PATCH",
